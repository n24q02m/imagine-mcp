...
# ⚡ Bolt: Extracting nested tools into module-level functions
# What: Moved nested tool implementations (_tool_understand, etc.) outside of build_app.
# Why: Recreating functions inside a factory method causes unnecessary overhead.
# Impact: Improves maintainability and eliminates redundant function object creation overhead upon instantiation.
