...
def _providers_configured() -> list[str]:
    ...
    # ⚡ Bolt: Use dict.fromkeys to deduplicate while strictly preserving insertion order
    # Expected impact: Replaces manual O(N) loop and set allocations with efficient C-level implementation
    return list(
        dict.fromkeys(
