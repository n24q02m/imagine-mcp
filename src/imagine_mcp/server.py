...
def _get_system_status_sync() -> dict[str, Any]:
    """Consolidated helper to gather version and credential state."""
        ...
        match action:
            ...
            case "status":
                ...
                return {
                    ...
                    "credentials_state": status_data["credentials_state"],
                    "providers_configured": status_data["providers_configured"],
