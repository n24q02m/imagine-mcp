...
def _get_system_status_sync(
    settings_default_provider: str,
    settings_default_tier: str,
    settings_cache_ttl_seconds: int,
) -> dict[str, Any]:
    ...
    return {
        ...
        "default_provider": settings_default_provider,
        "default_tier": settings_default_tier,
        "cache_ttl_seconds": settings_cache_ttl_seconds,
    }
