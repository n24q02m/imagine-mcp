...
MODELS: Final[list[ModelEntry]] = [
    # ----- understand.image -----
    ModelEntry("gemini", "understand", "image", "poor", "gemini-3.1-flash-lite-preview",
               quality_rank=1, cost_tier="low", last_verified=_BASELINE_DATE,
               sources=("arena.ai/leaderboard/vision",)),
    ModelEntry("openai", "understand", "image", "poor", "gpt-5.4-mini",
               quality_rank=2, cost_tier="low", last_verified=_BASELINE_DATE,
               sources=("arena.ai/leaderboard/vision",)),
    ModelEntry("grok", "understand", "image", "poor", "grok-4.20-0309-non-reasoning",
               quality_rank=3, cost_tier="low", last_verified=_BASELINE_DATE,
               sources=("arena.ai/leaderboard/vision",)),
    ModelEntry("gemini", "understand", "image", "rich", "gemini-3.1-pro-preview",
               quality_rank=1, cost_tier="high", last_verified=_BASELINE_DATE,
               sources=("arena.ai/leaderboard/vision",)),
    ModelEntry("openai", "understand", "image", "rich", "gpt-5.4",
               quality_rank=2, cost_tier="high", last_verified=_BASELINE_DATE,
               sources=("arena.ai/leaderboard/vision",)),
    ModelEntry("grok", "understand", "image", "rich", "grok-4.20-0309-reasoning",
               quality_rank=3, cost_tier="high", last_verified=_BASELINE_DATE,
               sources=("arena.ai/leaderboard/vision",)),
    # ----- understand.video (Gemini only) -----
    ModelEntry("gemini", "understand", "video", "poor", "gemini-3.1-flash-lite-preview",
               quality_rank=1, cost_tier="low", last_verified=_BASELINE_DATE,
               notes="Native multimodal; no dedicated video leaderboard."),
    ModelEntry("openai", "understand", "video", "poor", UNSUPPORTED,
               quality_rank=None, cost_tier="low", last_verified=_BASELINE_DATE,
               notes="GPT-5.4 image-only; extract frames or use gemini."),
    ModelEntry("grok", "understand", "video", "poor", UNSUPPORTED,
               quality_rank=None, cost_tier="low", last_verified=_BASELINE_DATE,
               notes="Prod 4.20-0309-v2 image-only."),
    ModelEntry("gemini", "understand", "video", "rich", "gemini-3.1-pro-preview",
               quality_rank=1, cost_tier="high", last_verified=_BASELINE_DATE),
    ModelEntry("openai", "understand", "video", "rich", UNSUPPORTED,
               quality_rank=None, cost_tier="high", last_verified=_BASELINE_DATE),
    ModelEntry("grok", "understand", "video", "rich", UNSUPPORTED,
               quality_rank=None, cost_tier="high", last_verified=_BASELINE_DATE),
    # ----- generate.image -----
    ModelEntry("gemini", "generate", "image", "poor", "gemini-3.1-flash-image-preview",
               quality_rank=1, cost_tier="low", last_verified=_BASELINE_DATE,
               sources=("artificialanalysis.ai/image/leaderboard/text-to-image",
                        "arena.ai/leaderboard/text-to-image"),
               notes="Nano Banana 2."),
    ModelEntry("openai", "generate", "image", "poor", "gpt-image-1-mini",
               quality_rank=2, cost_tier="low", last_verified=_BASELINE_DATE,
               sources=("artificialanalysis.ai/image/leaderboard/text-to-image",)),
    ModelEntry("grok", "generate", "image", "poor", "grok-imagine-image",
               quality_rank=3, cost_tier="low", last_verified=_BASELINE_DATE,
               sources=("artificialanalysis.ai/image/leaderboard/text-to-image",
                        "arena.ai/leaderboard/text-to-image"),
               notes="Aurora."),
    ModelEntry("gemini", "generate", "image", "rich", "gemini-3-pro-image-preview",
               quality_rank=1, cost_tier="high", last_verified=_BASELINE_DATE,
               sources=("artificialanalysis.ai/image/leaderboard/text-to-image",
                        "arena.ai/leaderboard/text-to-image"),
               notes="Nano Banana Pro. Cross-gen: no 3.1-pro-image as of 2026-04-18."),
    ModelEntry("openai", "generate", "image", "rich", "gpt-image-1.5",
               quality_rank=2, cost_tier="high", last_verified=_BASELINE_DATE,
               notes="Cross-gen: no gpt-image-1.5-mini yet."),
    ModelEntry("grok", "generate", "image", "rich", "grok-imagine-image-pro",
               quality_rank=3, cost_tier="high", last_verified=_BASELINE_DATE),
    # ----- generate.video -----
    ModelEntry("gemini", "generate", "video", "poor", "veo-3.1-lite-generate-preview",
               quality_rank=1, cost_tier="low", last_verified=_BASELINE_DATE,
               sources=("artificialanalysis.ai/video/leaderboard/text-to-video",
                        "arena.ai/leaderboard/text-to-video")),
    ModelEntry("grok", "generate", "video", "poor", "grok-imagine-video",
               quality_rank=2, cost_tier="medium", last_verified=_BASELINE_DATE,
               notes="Single tier -- same model for poor and rich."),
    ModelEntry("openai", "generate", "video", "poor", UNSUPPORTED,
               quality_rank=None, cost_tier="low", last_verified=_BASELINE_DATE,
               notes="Sora 2 API shutdown 2026-09-24."),
    ModelEntry("gemini", "generate", "video", "rich", "veo-3.1-generate-preview",
               quality_rank=1, cost_tier="high", last_verified=_BASELINE_DATE,
               sources=("artificialanalysis.ai/video/leaderboard/text-to-video",
                        "arena.ai/leaderboard/text-to-video")),
    ModelEntry("grok", "generate", "video", "rich", "grok-imagine-video",
               quality_rank=2, cost_tier="medium", last_verified=_BASELINE_DATE),
    ModelEntry("openai", "generate", "video", "rich", UNSUPPORTED,
               quality_rank=None, cost_tier="high", last_verified=_BASELINE_DATE),
]
...
def rank_for(
    provider: str, action: str, media: str, tier: str
) -> "int | None":
