...
async def _passthrough_understand(
    ...
    # ⚡ Bolt: Pipeline URL validation and network request to remove barrier sync delay.
    # Expected impact: Eliminates waiting for the slowest DNS resolve before starting fast fetches.
...
async def dispatch_understand(
    ...
    # ⚡ Bolt: Pipeline URL validation and media type detection to remove barrier sync delay.
    # Expected impact: Eliminates waiting for the slowest DNS resolve before starting HEAD requests.
